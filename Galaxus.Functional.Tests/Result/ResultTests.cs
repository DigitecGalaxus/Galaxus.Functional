...
namespace Galaxus.Functional.Tests.Result;
...
public class ResultTests
{
    ...
    public void Result_AndThenFunc_IsOk()
    {
        ...
        Result<Functional.Unit, int> Nop(string s)
        {
        ...
        Assert.AreEqual(Functional.Unit.Value, nextResult.Ok.Unwrap());
    }
    ...
    public void Result_AndThenFunc_IsErr()
    {
        ...
        Result<Functional.Unit, int> Nop(Result<string, int> x)
        {
            return x.Match(_ => Result<Functional.Unit, int>.FromOk(Functional.Unit.Value), err => err);
        }
